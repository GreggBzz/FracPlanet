...
public class PlanetCloudsAndStars : MonoBehaviour {
    ...
    public Vector3[] TextureCloudMesh(Vector3[] vertices, int[] triangles) {
        ...
        // - cycle through all the triangles. find which triangles contain verts that have wrap around UV corrdinates.
        // - duplicate those verts. assign those duplicated verts a corrected UV coordiante. 
        // - remove the offending verts from their original triangles. assign the duplicates back to the offending triangles.
