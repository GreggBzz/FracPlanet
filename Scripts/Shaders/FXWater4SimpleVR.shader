...
CGINCLUDE
	...
	half4 frag( v2f i ) : SV_Target
	{
		...
		half4 rtRefractions = tex2Dproj(_RefractionTex, UNITY_PROJ_COORD(grabWithOffset));
			...
			half4 rtReflections0 = tex2Dproj(_ReflectionTex, UNITY_PROJ_COORD(screenWithOffset));
			half4 rtReflections1 = tex2Dproj(_ReflectionTex, UNITY_PROJ_COORD(screenWithOffset));
			half4 rtReflections = lerp(rtReflections0, rtReflections1, i.eyeIndex);
		#endif
